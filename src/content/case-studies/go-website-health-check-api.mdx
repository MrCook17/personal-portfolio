...
- Store completed results in memory for a simple portfolio-ready backend service.
...
- Improving the README with more screenshots and benchmark evidence.
